...
class Blockchain:
    def __init__(self):
        ...
        self.transaction = "Dota2:The International 10"
        #genesis block
...
#------ ข้อมูลการแข่งขัน e-sport --------
title = [
        "THE INTERNATIONAL  กลุ่ม A","THE INTERNATIONAL  กลุ่ม A",
        "THE INTERNATIONAL  กลุ่ม A","THE INTERNATIONAL  กลุ่ม A",
        "THE INTERNATIONAL  กลุ่ม A","THE INTERNATIONAL  กลุ่ม B",
        "THE INTERNATIONAL  กลุ่ม B","THE INTERNATIONAL  กลุ่ม B",
        "THE INTERNATIONAL  กลุ่ม B","THE INTERNATIONAL  กลุ่ม B"
        ]

team1 = [
        "VIRTUS.PRO","OG","INVICTUS GAMING","EVIL GENIUSES",
        "VICI GAMING","TEAM SECRET","PSG.LGD","NEPTUNE GAMING",
        "INVICTUS GAMING","OG"
        ]
team2 = [
        "TSM FTX","ALLIANCE","T1","TEAM ASTER","FNATIC",
        "TEAM SPIRIT","QUINCY CREW","BEASTCOAST","TSM FTX",
        "THUNDER PREDATOR"
        ]
score = ["2-0","2-0","2-0","2-0","1-1","2-0","2-0","2-0","1-1","2-0"]
...
def mining_block():
    ...
    data = {
        "การแข่งขัน Dota2":title[num-1],
        "ทีม1 ":team1[num-1],
        "ทีม2 ":team2[num-1],
        "ผลการแข่งขัน :":score[num-1]
    }
